...
ALTER TABLE "car" ADD CONSTRAINT "car_fk1" FOREIGN KEY ("foto_id") REFERENCES "foto"("id");
...
ALTER TABLE "place_owner" ADD CONSTRAINT "place_owner_fk0" FOREIGN KEY ("client_id") REFERENCES "client"("id");
